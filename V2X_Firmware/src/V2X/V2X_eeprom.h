...
// uint8_t EEMEM EE_timezone;
// uint8_t EEMEM EE_dst;
// uint8_t EEMEM EE_check_byte;
// uint8_t EEMEM EE_can_array;

// eeprom_addr_t EE_timezone;
// eeprom_addr_t EE_dst;
// eeprom_addr_t EE_can_array[30];
// eeprom_addr_t EE_check_byte;
 ...
 * @brief pass in a string and it will be stored to 
 **/
